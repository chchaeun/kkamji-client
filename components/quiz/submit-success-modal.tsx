...
function SubmitSuccessModal({
  ...
  return (
    <div className="grid grid-rows-6 grid-cols-10 items-center justify-center gap-5 fixed w-2/5 h-1/3 left-1/2 top-1/4 -translate-x-1/2 bg-white rounded-lg z-10">
      <Icon
        icon="bi:x-lg"
        color="black"
        height="30"
        onClick={onMainClick}
        className="row-start-1 col-start-10 mt-5 cursor-pointer"
      />
      <p className="row-start-3 col-start-3 col-span-6 flex flex-col items-center text-lg">
