...
function QuizCommentForm({ quizId }: Props) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex items-center w-fit bg-[#5c3cde] hover:bg-[#4026ab] text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline cursor-pointer"
